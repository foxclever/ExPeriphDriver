                              ...
                              )
{
    ...
    bme->caliPara.dig_t1=0;
    bme->caliPara.dig_t2=0;
    bme->caliPara.dig_t3=0;
    bme->caliPara.dig_p1=0;
    bme->caliPara.dig_p2=0;
    bme->caliPara.dig_p3=0;
    bme->caliPara.dig_p4=0;
    bme->caliPara.dig_p5=0;
    bme->caliPara.dig_p6=0;
    bme->caliPara.dig_p7=0;
    bme->caliPara.dig_p8=0;
    bme->caliPara.dig_p9=0;
    bme->caliPara.dig_h1=0;
    bme->caliPara.dig_h2=0;
    bme->caliPara.dig_h3=0;
    bme->caliPara.dig_h4=0;
    bme->caliPara.dig_h5=0;
    bme->caliPara.dig_h6=0;
